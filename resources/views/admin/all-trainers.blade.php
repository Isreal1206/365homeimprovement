          ...
          <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 main-chart">
            <div class="row mt">
              ...
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mb">
                <h4 class="text-center">ALL TRAINERS</h4>
            ...
            <div style="overflow-x:auto;" class="shadow p-1">
              <table class="table">
                ...
                <tr>
                  <td>{{$key+1}}</td>
                  <td class="text-capitalize">{{$trainer->fullnames}}</td>
                  <td class="text-capitalize">{{$trainer->organization}}</td>
                  <td class="text-capitalize">{{$trainer->job_title}}</td>
                  <td class="text-capitalize">{{$trainer->address}}</td>
                  <td>{{$trainer->mobile_no}}</td>
                  <td>{{$trainer->created_at}}</td>
                  <td class="text-center"><a href="{{url('admin/trainer-details/'.$trainer->trainer_id)}}" class="btn btn-md btn-info">MORE</a>&nbsp;<a href="javascript:void(0);" value="{{url('admin/delete-trainer/'.$trainer->id)}}" class="btn btn-md btn-danger" onclick="return confirm('are you sure you wana delete this item?')">DELETE</a></td>
                </tr>
                @endforeach
              </table>
