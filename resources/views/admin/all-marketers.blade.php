          ...
          <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 main-chart">
            <div class="row mt">
              ...
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mb">
                <h4 class="text-center">ALL MARKETERS</h4>
            ...
            <div style="overflow-x:auto;" class="shadow p-1">
              <table class ="table">
                ...
                <tr>
                  <td>{{$key+1}}</td>
                  <td class="text-capitalize">{{$marketer->fullnames}}</td>
                  <td class="text-capitalize">{{$marketer->category}}</td>
                  <td class="text-capitalize">{{$marketer->status}}</td>
                  <td>{{$marketer->mobile_no}}</td>
                  <td>{{$marketer->created_at}}</td>
                  <td class="text-center"><a href="{{url('admin/marketer-details/'.$marketer->marketer_id)}}" class="btn btn-md btn-info">More</a>&nbsp;<a href="{{url('delete-marketer/'.$marketer->id)}}" class="btn btn-md btn-danger" onclick="return confirm('are you sure you wana delete this item?')">Delete</a></td>
                </tr>
                @endforeach
              </table>

              <div class="mt-3">{{$marketers->links()}}</div>
            </div>
