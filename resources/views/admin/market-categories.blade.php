                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td class="text-center">
                                  <form action="{!! action('Admin\MarketCategoriesController@delete', $category->id) !!}" method="PUT" class="delete">
                        ...
                        <div class="table-responsive">
                          <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                              ...
                              <form action="{{route('admin.marketcategory.edit', $category->id)}}" method="POST">
                              @csrf
                              <tr>
                                <th>{{$category->id}}</th>
                                <td>
                                ...
                                <td>
                                  <input type="text" name="sub_name" value="{{$category->sub_name}}" class="form-control bord">
            ...
            <div class="row">
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="bg-primary" style="padding: 10px">
                  <form action = "{{route('admin.marketcategory.store')}}" method = "POST" >
                  @csrf
                    <h4 class="text-center">Create Market Category</h4>
                    <div class="form-group">
                      <input type="text" placeholder="Enter Name" id="name" class="form-control" name="name" autocomplete="name">
                      <small class="text-danger">{{ $errors->first('name') }}</small>
                    </div>
                    <div class="form-group">
                      <input type="text" placeholder="Enter Name" id="sub_name" class="form-control" name="sub_name" autocomplete="sub_name">
                      <small class="text-danger">{{ $errors->first('sub_name') }}</small>
                    </div>
                    <div class="form-group">
