      ...
      <div class="row">
        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
          <div class="alert alert-dark mt-3 mb-5">
            ...
            <i class="fa fa-angle-double-right"></i>
            <span class="mx-2"><a href="{{url('#')}}">Accountant</a></span>
          </div>
        </div>
      </div>
      ...
      <div class="row mb-5">
        ...
        <div class="col-12 col-sm-12 col-md-5 col-lg-5 offset-md-1">
          <div> 
            ...
            <p>Step 1:</p>
            <p>Fill in the form at your left hand side and click the submit button if you're an Accountant or your profession is related to an Accounting job.</p>
            <hr>
            <p>Step 2:</p>
