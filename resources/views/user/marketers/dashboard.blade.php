          ...
          <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 main-chart">
            <div class="row mt">
              <div class="col-lg-10 col-md-offset-1">
                @if($flash = session('marketer_register'))
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 mb">
                <div class="panel-box">
                  ...
                  <a href="{{route('marketer.profile')}}" class="btn btn-orange">Click here</a>
                </div>
              </div>
              <!-- /col-md-6 -->
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 mb">
                <div class="panel-box">
                  ...
                  <div class="pad">
                    ...
                    <h3 class="title">MARKETER</h3>
                    <p>To become a Marketer</p>
                    <a href="{{route('marketer.register')}}" class="btn btn-orange">Click here</a>
                  </div>
                </div>
              </div>
              @else
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 mb">
                <div class="panel-box">
                  ...
                  <div class="pad">
                    ...
                    <a href="{{route('marketer.index')}}" class="btn btn-orange">Click here</a>
                  </div>
                </div>
              </div>
              <!-- /col-md-6 -->
