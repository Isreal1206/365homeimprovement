            ...
            <div class="row mt">
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 mb">
                <div class="panel-box">
                  ...
                  <a href="{{route('homeowner.profile')}}" class="btn btn-orange">Click here</a>
                </div>
              </div>
              <!-- /col-md-6 -->
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 mb">
                <div class="panel-box">
                  <p class="banner">365Homeimprovement</p>
                  <div class="pad">
                    <i class="fa fa-home fa-4x text-light"></i>
                    <h3 class="title">HOME OWNER</h3>
                    <p>To become a Home Owner</p>
                    <a href="{{route('homeowner.register')}}" class="btn btn-orange">Click here</a>
                  </div>
                </div>
              </div>
              @else
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 mb">
                <div class="panel-box">
                  ...
                  <div class="pad">
                    ...
                    <a href="{{route('homeowner.index')}}" class="btn btn-orange">Click here</a>
                  </div>
                </div>
              </div>
              <!-- /col-md-6 -->
