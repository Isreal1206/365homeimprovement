          ...
          <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 main-chart">
            ...
            <div class="row mt">
              <div class="col-lg-10 col-md-offset-1">
                @if($flash = session('trainer_register'))
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 mb">
                <div class="panel-box">
                  ...
                  <p>Change your profile image or Reset your password.</p>
                  <a href="{{route('trainer.profile')}}" class="btn btn-orange">Click here</a>
                </div>
              </div>
              <!-- /col-md-6 -->
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 mb">
                <div class="panel-box">
                  ...
                  <div class="pad">
                    ...
                    <a href="{{route('trainer.register')}}" class="btn btn-orange">Click here</a>
                  </div>
                </div>
              </div>
              @else
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 mb">
                <div class="panel-box">
                  ...
                  <div class="pad">
                    ...
                    <a href="{{route('trainer.index')}}" class="btn btn-orange">Click here</a>
                  </div>
                </div>
              </div>
              <!-- /col-md-6 -->
